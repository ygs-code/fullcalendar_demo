$(function () {
  ...
  var calendar = $("#calendar").fullCalendar({
    ...
    selectAllow: function (selectInfo) {
      ...
      console.log(
        "start:" +
          selectInfo.start.format() +
          "|end:" +
          selectInfo.end.format() +
          "|resourceId:" +
          selectInfo.resourceId
      );
      return true;
    },
    ...
    eventDrop: function (
      ...
      if (dayDelta._days != 0) {
        console.log(
          "eventDrop被执行，Event的start和end时间改变了：",
          dayDelta._days + "天！"
        );
      } else if (dayDelta._milliseconds != 0) {
        console.log(
          "eventDrop被执行，Event的start和end时间改变了：",
          dayDelta._milliseconds / 1000 + "秒！"
        );
      } else {
